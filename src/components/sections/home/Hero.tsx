...
const DEFAULT_HERO = {
  ...
  description:
    "QuickLand's intelligent builder creates high-converting landing pages with minimal effort. Perfect for developers, marketers, and startups who need results fast.",
  features: [
