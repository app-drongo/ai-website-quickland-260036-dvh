...
export default function Footer({
  logoText = 'QuickLand',
  companyDescription = 'The fastest way to build and deploy landing pages. Create stunning, high-converting pages in minutes with our drag-and-drop builder and professional templates.',
  contactEmail = 'hello@quickland.com',
  contactPhone = '+1 (555) 123-4567',
  contactAddress = '123 Innovation Drive, San Francisco, CA 94107',
  newsletterTitle = 'Stay Updated',
  newsletterDisclaimer = 'Get the latest landing page tips, templates, and feature updates. No spam, unsubscribe anytime.',
  section1Title = 'Product',
  section2Title = 'Company',
  section3Title = 'Resources',
  section4Title = 'Legal',
  copyrightText = '© 2024 QuickLand. All rights reserved.',
  madeWithText = 'by the QuickLand team',
  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'Page Builder', href: '/builder' },
